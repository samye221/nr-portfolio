...
export function PinterestSaveButton({
  ...
  const handleSave = useCallback(() => {
    ...
    window.open(
      url.toString(),
      'pinterest-share',
      'width=750,height=600,menubar=no,toolbar=no,resizable=yes,scrollbars=yes'
    )
  ...
  return (
    <button
      ...
      className={`cursor-auto flex h-8 w-8 items-center justify-center rounded-full bg-[#E60023] text-white transition-transform hover:scale-110 ${className}`}
